...
def create_app(config_class=Config):
    ...
    from blueprints.design_preview import design_preview_bp
    ...
    app.register_blueprint(design_preview_bp)
    ...
    def inject_globals():
        return dict(
            ...
            LOOK_MOMENTS=LOOK_MOMENTS,
            CLOSET_ITEM_CATEGORIES=CLOSET_ITEM_CATEGORIES,
            PERSONAL_SHOPPER_STATUSES=PERSONAL_SHOPPER_STATUSES,
